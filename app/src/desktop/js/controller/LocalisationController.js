    ...
    _public: {
        ...
        init: function () {
            ...
            Handlebars.registerHelper('t', function (i18n_key) {
                var string = window.i18n.t(i18n_key);
                if (string === '[MISSING]') {
                    string = window.i18n.t(i18n_key, {lng: 'en-us'});
                }
        ...
        initI18Next: function (qs) {
            ...
            window.i18n.init({
                ...
                cookieName: 'lng',
                ns: 'desktop', // this is a desktop site so we enforce that locale
        ...
        isLanguageSupported: function (language, callback) {
            ...
            $.get(Config.getInstance().localisationResGetPath.replace('__lng__', language).replace('__ns__', 'desktop')).done(function () {
                callback(true);
            }).error(function () {
                callback(false);
            });
