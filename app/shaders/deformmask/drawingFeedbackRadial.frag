...
void main() {
	...
	mediump vec3 result = 
		...
		texture2D(tAccum,vUv-stepuv*0.333).rgb * texture2D(tDrawing, vUv-stepuv*0.333).r * accumSpeed + 
		texture2D(tAccum,vUv-stepuv*0.666).rgb * texture2D(tDrawing, vUv-stepuv*0.666).r * accumSpeed + 
		texture2D(tAccum,vUv-stepuv*0.999).rgb * texture2D(tDrawing, vUv-stepuv*0.999).r * accumSpeed;
