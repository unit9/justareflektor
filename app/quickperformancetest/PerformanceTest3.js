(function(document,window) {
		...
		var PerformanceTest = window.PerformanceTest = {
			...
			create : function(_renderer) {
				...
				canvas.width = TEST_UPLOAD_SIZE;
				canvas.height = TEST_UPLOAD_SIZE;
				c = canvas.getContext('2d');
				c.fillStyle = 'black';
				c.fillRect(0,0,TEST_UPLOAD_SIZE,TEST_UPLOAD_SIZE);
				...
				renderTarget = new THREE.WebGLRenderTarget(TEST_SIZE,TEST_SIZE, {
					antialias:true,
			...
			onFinished : function() {
				...
				console.log('Webgl Performance Score: '+t/(NUM_FRAMES-NUM_SPLICE*2));
