...
(function(global) {
	global.RectangleUtils = {
		...
		sortOnDist: function(a,b) {
			if (a.dist===b.dist) return 0;
			return (a.dist>b.dist)?1:-1;
		},

		distanceBetweenRectangles: function(ca,cb) {
			...
			return Math.sqrt(averageDist/4.0);
		},


		distanceBetweenCandidates: function(ca,cb, ratio) {
			var a,b,dist,averageDist = 0.0;
			...
			return averageDist/6.0;
		},



		sortPolygon: function(poly) {
			...
			//get angles
			for (var i=0; i<poly.length; i++) {
				poly[i].angle = Math.atan2(cx - poly[i].x, cy - poly[i].y);
			}

			//sort angles
			return poly.sort(function(a,b) {
				return (a.angle>b.angle)?1:-1;
			});
		},

		distanceBetweenPolygons: function(ca,cb) {
			var a,b,dist,averageDist = 0.0;
			...
			return Math.sqrt(averageDist/ca.length);
		},
	};
})(this);